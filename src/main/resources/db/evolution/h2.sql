...
INSERT INTO SYS_USERS (ID,SALT,USERNAME,PASSWORD,ENABLED,FULLNAME,EMAIL,CREATED_AT,UPDATED_AT)
  SELECT 1,'700f67512749aa786d7ed310e1844305','zhaoding','bf4ee4ea014b4d51f4db07ec78630e265c341da5a9d0780c54765db2b39a37e1',1,'pluto4321@163.com','大熊',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP() FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_USERS T1 WHERE T1.ID=1);
INSERT INTO SYS_USERS (ID,SALT,USERNAME,PASSWORD,ENABLED,FULLNAME,EMAIL,CREATED_AT,UPDATED_AT)
  SELECT 2,'8aec2c4352891e2efd5aeab3af24483e','zhangchengsi','e0a29e75d9e24d84ebed23b48ebd808601d52a9dc951c7158bc658d41058b4e7',1,'284839053@qq.com','暖暖',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP() FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_USERS T1 WHERE T1.ID=2);
...
--日报搜索资源
INSERT INTO SYS_RESOURCES(ID,NAME,PERMISSION,VALUE) SELECT 34,'日报搜索','perms[daily:index],authc','/search/daily/index' FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_RESOURCES WHERE VALUE='/search/daily/index');
INSERT INTO SYS_RESOURCES(ID,NAME,PERMISSION,VALUE) SELECT 35,'日报检索','perms[daily:search],authc','/search/daily/search' FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_RESOURCES WHERE VALUE='/search/daily/search');
--研报搜索资源
INSERT INTO SYS_RESOURCES(ID,NAME,PERMISSION,VALUE) SELECT 36,'研报搜索','perms[research:index],authc','/search/research/index' FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_RESOURCES WHERE VALUE='/search/research/index');
INSERT INTO SYS_RESOURCES(ID,NAME,PERMISSION,VALUE) SELECT 37,'研报检索','perms[research:search],authc','/search/research/search' FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_RESOURCES WHERE VALUE='/search/research/search');
--数据字典资源
INSERT INTO SYS_RESOURCES(ID,NAME,PERMISSION,VALUE) SELECT 38,'数据字典列表','perms[dictionary:list],authc','/system/dictionary/list' FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_RESOURCES WHERE VALUE='/system/dictionary/list');
--系统信息资源
INSERT INTO SYS_RESOURCES(ID,NAME,PERMISSION,VALUE) SELECT 39,'系统信息','perms[system-info:list],authc','/system/system-info/list' FROM DUAL WHERE NOT EXISTS(SELECT 1 FROM SYS_RESOURCES WHERE VALUE='/system/system-info/list');
--初始化菜单
/*
1.搜索管理
	1.1参数设置
