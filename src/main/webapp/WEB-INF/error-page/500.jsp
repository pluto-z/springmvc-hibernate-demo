...
<% if (request.getAttribute("ex_head") != null){ %>
<!DOCTYPE html>
<html>
<head>
    <title>访问控制</title>
    ...
    <link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/static/plugins/bootstrap/css/bootstrap.min.css"/>
...
<div id="exception_container" class="server-exception">
    ...
    <section>
        程序错误
        <a class="btn btn-default pull-right" href="javascript:void(0)" onclick="history.back()">
