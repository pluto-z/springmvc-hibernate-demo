...
public class Configuration implements Serializable {
	...
	private static final CoreMessageLogger LOG = Logger
			.getMessageLogger(CoreMessageLogger.class, Configuration.class.getName());
	...
	public Configuration addURL(URL url) throws MappingException {
		...
		try {
			...
			throw new InvalidMappingException("Unable to open url stream [" + urlExternalForm + "]", "URL", urlExternalForm,
					e);
		}
		return this;
	}
	...
	private AttributeConverter instantiateAttributeConverter(
	...
	protected class MappingsImpl implements ExtendedMappings, Serializable {
		...
		public void addClass(PersistentClass persistentClass) throws DuplicateMappingException {
			...
			if (StringUtils.isNotBlank(jpaEntityName)) {
				persistentClass.setEntityName(jpaEntityName);
			}
			Object old = classes.put(persistentClass.getEntityName(), persistentClass);
			if (old != null) {
				throw new DuplicateMappingException(DuplicateMappingException.Type.ENTITY, persistentClass.getEntityName());
			}
			classes.put(persistentClass.getClassName(), persistentClass);
		}
		...
		public void addImport(String entityName, String rename) throws DuplicateMappingException {
			...
			if (existing != null) {
				if (existing.equals(entityName)) LOG.duplicateImport(entityName, rename);
					...
					throw new DuplicateMappingException("duplicate import: " + rename + " refers to both " + entityName + " and "
