...
import com.ptsisi.common.model.IntegerIdHierarchyObject;
...
public class MenuBean extends IntegerIdHierarchyObject<Menu> implements com.ptsisi.daily.Menu {
	...
	@JoinTable(name = "SYS_MENUS_RESOURCES", joinColumns = { @JoinColumn(name = "MENU_ID", updatable = false) },
