 ...
 */
public abstract class HibernateGenericDao<T> extends HibernateDaoSupport<T>
	 ...
	 * @return
	 */
	public List<T> findBy(String propertyName, Object value, boolean isAsc,
			String orderBy) {
	...
	public T findUniqueBy(String propertyName, Object value) {
		return findUniqueBy(entityClass, propertyName, value);
	}
